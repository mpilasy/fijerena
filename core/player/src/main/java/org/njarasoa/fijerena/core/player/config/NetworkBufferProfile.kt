...
object NetworkBufferProfile {
    ...
    const val CELLULAR_LIVE_MAX_BUFFER_MS = 60_000
    ...
    const val CELLULAR_VOD_MAX_BUFFER_MS = 60_000
    const val CELLULAR_VOD_PLAYBACK_MS = 5_000
    ...
    const val CELLULAR_CONNECT_TIMEOUT_MS = 30_000
    const val CELLULAR_READ_TIMEOUT_MS = 45_000
