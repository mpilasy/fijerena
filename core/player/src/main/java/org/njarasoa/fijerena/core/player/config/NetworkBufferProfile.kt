...
object NetworkBufferProfile {
    ...
    // ── Cellular Live TV ────────────────────────────────────────────
    const val CELLULAR_LIVE_MIN_BUFFER_MS = 3_000
    const val CELLULAR_LIVE_MAX_BUFFER_MS = 10_000
    ...
    // ── Cellular VOD ────────────────────────────────────────────────
    const val CELLULAR_VOD_MIN_BUFFER_MS = 5_000
    const val CELLULAR_VOD_MAX_BUFFER_MS = 20_000
