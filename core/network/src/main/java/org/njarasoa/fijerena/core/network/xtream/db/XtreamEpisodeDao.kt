...
interface XtreamEpisodeDao {
     ...
     * docs/plans/20260828_watch-state-durable-storage-plan.md) on an episode with no existing `watch_state` row.
    ...
    /**
     * Phase 5 dedup (docs/plans/20260828_watch-state-durable-storage-plan.md), corrected 2026-08-27 after an
