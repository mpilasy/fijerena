...
interface EpgSourceDao {
    ...
    @Query("UPDATE epg_source SET last_ingested_at_ms = :timestamp, last_error = NULL, last_channels = :channels, last_programmes = :programmes, last_download_bytes = :downloadBytes, ingest_method = :ingestMethod, last_ingestion_duration_ms = :ingestionDurationMs, last_download_duration_ms = :downloadDurationMs WHERE id = :id")
    suspend fun markIngested(id: Long, timestamp: Long, channels: Int, programmes: Int, downloadBytes: Long, ingestMethod: String = "DOWNLOADED", ingestionDurationMs: Long = 0, downloadDurationMs: Long = 0)
    ...
    @Query("UPDATE epg_source SET last_ingested_at_ms = 0, last_channels = 0, last_programmes = 0, last_download_bytes = 0, last_error = NULL, last_ingestion_duration_ms = 0, last_download_duration_ms = 0")
