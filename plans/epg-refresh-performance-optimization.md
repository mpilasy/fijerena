# EPG Refresh Performance Optimization

This document outlines strategies and alternatives to solve massive I/O bottlenecks during EPG ingestion, especially on Android TV devices with eMMC storage (like the NVIDIA Shield).

---

## Part 1: SQLite Ingestion Optimization Plan (Current Architecture)
...
## Part 2: EPG Storage Alternatives

If we decide to move away from SQLite entirely, here is an exploration of alternative storage and indexing mechanisms for EPG data.
